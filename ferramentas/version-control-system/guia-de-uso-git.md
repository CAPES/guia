...
- **/devops/backend**: pasta destinada ao Dockerfile e Chart do backend.
- **/devops/frontend**: pasta destinada ao Dockerfile e Chart do frontend.
- **/system**: pasta que agruapará o conteúdo do sistema.
- **/system/backend**: pasta que agruapará o conteúdo do backend.
- **/system/frontend**: pasta que agruapará o conteúdo do frontend.
- **/README.md**: arquivo usado para documentar procedimentos/caractérias relevantes do sistema.
